...
export default function FormMedicao2({ inicial, m1, onSalvar, onCancelar }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm grid place-items-end md:place-items-center p-0 md:p-5 z-50" onClick={onCancelar} role="dialog" aria-modal="true" aria-labelledby="form-m2-titulo">
